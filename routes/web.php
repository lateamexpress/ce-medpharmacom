...
Route::group(["middleware" => "auth"],function(){
    ...
    Route::group(['middleware' => "admin","prefix" => "admin"],function(){
        ...
        Route::get('/gestion-commandes/{id}', 'GestionCommandeController@commandeParId');
    ...
    Route::group(["middleware" =>"users"],function(){
        ...
        Route::post('/catalogue/filtre', 'CatalogueController@produitFiltre');
...
//        Route::get('/commande', 'CommandeController@index');
        ...
        Route::post('mon-panier', 'PanierController@deleteProduit');
